    ...
    <img src={logoImage} alt="Logo" className="header-logo" />
      ...
      <div className={`sideMenu ${isMenuOpen ? "open" : ""}`}>
        ...
        <ul className="menuItems">
          ...
          <li>
            <button className="menuButton" onClick={toggleMarketsDropdown}>
              ...
              <FaChevronRight
                className={`dropdown-arrow ${marketsOpen ? "open" : ""}`}
              />
            </button>
            <ul className={`dropdown ${marketsOpen ? "open" : ""}`}>
              <li>
                <button
                  ...
                  onClick={() => toggleStallsDropdown("market1")}
                >
                  <a href="/Market">Market 1</a>
                  <FaChevronRight
                    className={`dropdown-arrow ${
                      stallsOpen.market1 ? "open" : ""
                    }`}
                  />
                </button>
                <ul
                  className={`stallsDropdown ${
                    stallsOpen.market1 ? "open" : ""
                  }`}
                >
              ...
              <li>
                <button
                  className="menuButton"
                  onClick={() => toggleStallsDropdown("market2")}
                >
                  <a href="/Market">Market 2</a>
                  <FaChevronRight
                    className={`dropdown-arrow ${
                      stallsOpen.market2 ? "open" : ""
                    }`}
                  />
                </button>
                <ul
          ...
          <li>
            <a href="/AppSettings" onClick={toggleMenu}>
              App Settings
            </a>
          </li>
          <li>
            <a href="/AccountDetails" onClick={toggleMenu}>
              Account Details
            </a>
          </li>
        </ul>
        <div className="logoutButton-header">
          <button
            className="logoutButton-header-btn"
